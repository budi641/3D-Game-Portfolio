export default {
  ...
  type: 'document',
  initialValue: {
    title: 'Abdelrahman Ameen 3D Game Dev Portfolio',
    description: 'Game developer portfolio showcasing projects, experience, and contact. Abdelrahman Ameen.',
  ...
  fields: [
    { name: 'title', type: 'string', title: 'Site Title', group: 'general', description: 'Used for browser tab and search results.' },
    { name: 'description', type: 'text', title: 'Site Description', group: 'general', description: 'Meta description for search engines.' },
    { name: 'logo', type: 'image', title: 'Logo', group: 'general' },
    {
      ...
      description: 'Image shown when sharing on social media (Open Graph, Twitter). Recommended 1200×630px.',
    },
    {
      name: 'ogTitle',
      type: 'string',
      ...
      group: 'seo',
      description: 'Override for social sharing. Leave empty to use Site Title.',
    },
    {
      name: 'ogDescription',
      type: 'text',
      ...
      group: 'seo',
      rows: 3,
      description: 'Override for social sharing. Leave empty to use Site Description.',
    },
    {
      name: 'keywords',
      type: 'string',
      title: 'Meta Keywords',
      group: 'seo',
      description: 'Comma-separated keywords for search engines (e.g. game developer, portfolio, Unreal Engine).',
    },
    {
      name: 'canonicalUrl',
      type: 'url',
      title: 'Canonical URL',
      group: 'seo',
      description: 'Preferred URL for this site (e.g. https://yoursite.com). Used for SEO and social sharing.',
    },
    {
